    ...
    <table class="border-all">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="text-center">{{ $user->created_at ? $user->created_at->format('d-m-Y H:i') : 'N/A' }}</td>
                <td class="text-center">{{ $user->updated_at ? $user->updated_at->format('d-m-Y H:i') : 'N/A' }}</td>
             </tr>
            @endforeach
        </tbody>
    </table>
