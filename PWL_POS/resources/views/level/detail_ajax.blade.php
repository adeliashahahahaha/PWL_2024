        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <table class="table table-sm table-bordered table-striped">
                    ...
                    <tr>
                        <th class="text-right col-3">Dibuat Pada:</th>
                        <td class="col-9">{{ $level->created_at }}</td>
                    </tr>
                    <tr>
                        <th class="text-right col-3">Diperbarui Pada:</th>
                        <td class="col-9">{{ $level->updated_at }}</td>
                    </tr>
                </table>
            </div>
