...
$(document).ready(function() {
    $("#form-import").validate({
        rules: {
            file_barang: {
                required: true,
                extension: "xlsx" // Validasi hanya file .xlsx
            },
        },
        submitHandler: function(form) {
            var formData = new FormData(form); // Gunakan FormData untuk handle file upload
            $.ajax({
                url: form.action, // URL dari form action
                type: form.method, // Method dari form method
                data: formData, // Data dari form
                processData: false, // Tidak mengubah data (untuk file)
                contentType: false, // Tidak menambahkan contentType (untuk file)
                success: function(response) {
                    if (response.status) {
                        ...
                        Swal.fire({
                            ...
                            // Setelah notifikasi, reload halaman barang agar tetap di halaman barang
            ...
            return false; // Jangan submit form secara langsung
        },
        errorElement: 'span',
