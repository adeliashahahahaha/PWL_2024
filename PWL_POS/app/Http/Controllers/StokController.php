...
class StokController extends Controller
{
    ...
    public function list(Request $request) {
        $stok = StokModel::with('supplier', 'barang')->select('stok_id', 'supplier_id', 'barang_id', 'stok_tanggal', 'stok_jumlah');
        ...
        return DataTables::of($stok)
            ...
            ->addColumn('aksi', function ($stok) {
                ...
                $btn .= '<button onclick="deleteStok('.$stok->stok_id.')" class="btn btn-danger btn-sm">Hapus</button>'; // Memanggil fungsi delete
